...
As of Aug 22 the code will not compile in a vignette, but it all runs
in the interpreter.  The chunks are not evaluated but the code is in test_ukbb.R in tests/testthat.
